...
SET(OSG_ROOT ${DELTA3D_ROOT} CACHE PATH "OSG Path" )

FIND_PATH(OSG_INCLUDE_DIR osg/Node
  PATH_SUFFIXES inc include Frameworks win64 win64/inc
  HINTS
  ${OSG_ROOT}/include
  $ENV{OSG_DIR}
  $ENV{OSGDIR}
  $ENV{OSG_ROOT}
  ${CMAKE_SOURCE_DIR}/ext/win64
  ${CMAKE_SOURCE_DIR}/ext/win32
  ${PROJECT_PROJECT_DIR}/ext
  )
...
MACRO(FIND_OSG_LIBRARY MYLIBRARY MYLIBRARYNAME)
    FIND_LIBRARY(${MYLIBRARY}
        NAMES ${MYLIBRARYNAME}
        PATH_SUFFIXES lib build/lib lib64 build/lib64 win64 win64/lib Frameworks
        PATHS
        ${OSG_ROOT}
        $ENV{OSG_DIR}
        $ENV{OSGDIR}
...
FIND_OSG_LIBRARY(OSGVOLUME_LIBRARY_DEBUG osgVolume)
